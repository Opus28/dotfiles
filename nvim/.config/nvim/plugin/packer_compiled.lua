...
_G.packer_plugins = {
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/leon/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  nvim = {
    loaded = true,
    path = "/Users/leon/.local/share/nvim/site/pack/packer/start/nvim",
  ...
  ["tabline.nvim"] = {
    loaded = true,
    path = "/Users/leon/.local/share/nvim/site/pack/packer/start/tabline.nvim",
